...
object Tables {
    ...
    fun getBi(thrust: Double): Double {
        ...
        return linearInterpolate(
            ...
            right = biData[x1].first,
            target = thrust,
            targetLeft = biData[x0].second,
            targetRight = biData[x1].second
        )
    }

    private val biData = listOf(
        0.0 to 0.0265,
        400.0 to 0.0111,
        800.0 to 0.00777,
        1200.0 to 0.00679,
    ...
    fun getNi(m0: Double): Double {
        ...
        return linearInterpolate(
            ...
            right = niData[x1].first,
            target = m0,
            targetLeft = niData[x0].second,
            targetRight = niData[x1].second
        )
    }

    private val niData = listOf(
        0.0 to 0.04487,
        25.0 to 0.02475,
        50.0 to 0.01627,
        75.0 to 0.01264,
    ...
    fun getMiddleDensity(omega: Double): Double {
        ...
        return linearInterpolate(
            ...
            right = middleDensityData[x1].first,
            target = omega,
            targetLeft = middleDensityData[x0].second,
            targetRight = middleDensityData[x1].second
        )
    }

    private val middleDensityData = listOf(
        0.0 to 62.0,
        20.0 to 33.54185,
        40.0 to 26.71588,
        60.0 to 25.27462,
    ...
    fun getAlpha(omega: Double): Double {
        ...
        return linearInterpolate(
            ...
            right = alphaData[x1].first,
            target = omega,
            targetLeft = alphaData[x0].second,
            targetRight = alphaData[x1].second
        )
    }

    private val alphaData = listOf(
        0.0 to 0.02101,
        20.0 to 0.01539,
        40.0 to 0.01445,
        60.0 to 0.01407,
